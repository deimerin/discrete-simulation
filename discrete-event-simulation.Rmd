...
Simulación de las llegadas en 10 horas de simulación
```{r}
S<-vector()
u1<-vector()
u2<-vector()
...
Simulación del tiempo de servicio con distribución exponencial con tasa de 9 por hora
...
Ejecuta 1000 veces la simulación
```{r}
...
#out = unserv()
#plot(unserv(LL)[[4]],type="l", ylab="Numero de clientes", xlab="Eventos")
